...
CALL configure.bat --disable-all --enable-phar=shared --enable-json --enable-pcs --enable-one-shot --enable-cli --with-prefix=%PHPSRCDIR%\ext-dev-build\ --with-%EXTNAME%=shared %ZTSARG%
@ECHO ON
